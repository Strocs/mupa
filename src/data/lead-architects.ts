...
const vivianaGallery = import.meta.glob("../assets/viviana-hernandez/gallery/**")
const aliciaGallery = import.meta.glob("../assets/alicia-silva/gallery/**")
const libertadGallery = import.meta.glob("../assets/libertad-morales/gallery/**")
...
export const LEAD_ARCHITECTS: Architects = [
  ...
  },
  {
    ...
    description: '***La arquitecta Alicia Silva Riveros nació en 1954 en Quillota. A la edad de 12 años comienza sus primeros intereses por la arquitectura a través de su hermana pintora, quien le muestra un libro sobre la vida de Miguel Ángel. Guarda este interés hasta 1974, en donde ingresa a estudiar arquitectura en la Universidad de Chile, sede Valparaíso. Se titula de arquitecta con un proyecto que mostraba  un especial interés por sistemas constructivos y diseños de arquitectura sustentable. Su primer trabajo fue bajo el alero de un abogado, encargándose de temas legales referentes a terrenos, subdivisiones, loteos, etc. En XXXX se traslada al Valle del Elqui y conoce con mayor propiedad los sistemas constructivos artesanales e incorpora más en sus proyectos materiales naturales como la madera, piedra y tierra. En 1994 la invitan a participar como docente en la apertura de la Carrera de Arquitectura de la Universidad de La Serena, en donde imparte diferentes asignaturas y comienza su perfeccionamiento académico: en 1997 realiza un magíster en Ciencias de la Educación en la Universidad Autónoma de Barcelona; en 2002 un diplomado en Estudios avanzados en Desarrollo Urbano Sustentable en la Universidad Politécnica de Madrid; en 2003 un diplomado en Docencia Universitaria en la universidad de La Serena; en 2009 se doctora en “Desarrollo Urbano Sustentable” en la Universidad Politécnica de Madrid. En XXXX fue pionera en la Red Arcot- Càtedra Unesco Chile. Actualmente jubilada como docente, Alicia se dedica al cultivo y cuidado de la tierra, sigue trabajando de forma particular desarrollando proyectos dentro de la zona donde reside, también se dedica a la restauración y ocasionalmente apoya en proyectos de investigación.***',
    quote: '...A las futuras arquitectas, que se den cuenta de la responsabilidad que tenemos sobre nuestro planeta en todos los niveles de energía, tierra, agua, aire y sol. Cuando diseñamos una obra o cualquier actividad en relación a intervenciones espaciales, tenemos que tomar consciencia de que la creación que hacemos debe ser sana, fluida y tiene que dialogar con nuestro entorno más importante, que es el natural …',
    color: '#9571b0',
